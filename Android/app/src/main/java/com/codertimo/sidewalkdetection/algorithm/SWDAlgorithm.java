...
public class SWDAlgorithm
{
    ...
    {
        if (10 + mainComparableLine.slope < subComparableLine.slope
                || mainComparableLine.slope - 10 > subComparableLine.slope)
        {
            // |a + b -2c|
            return Math.abs(mainComparableLine.slope + subComparableLine.slope - 2 * SWDGlobalValue.currentSlopeAvg)
                    * (mainComparableLine.slope + subComparableLine.slope);
        }
        return 0;
    }
     ...
     * @return
     */
    public static double getNonlinearRegressionResult(double beta,
                                                      double avgLineSize,
                                                      ComparableLine mainComparableLine,
                                                      ComparableLine subComparableLine)
    {
